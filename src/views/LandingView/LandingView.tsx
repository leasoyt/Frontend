...
const LandingView = () => {
  ...
  <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16 bg-neutral-200 p-10 w-full h-screen items-center">
    <img src="https://i.pinimg.com/564x/ca/ec/73/caec73a701135c04bca7b6637fd946c8.jpg" alt="" className="rounded-3xl h-96 mx-auto"/>
    ...
    <img src="https://i.pinimg.com/564x/de/4b/99/de4b99b20d0aae208c223c653ebe4474.jpg" alt="" className="rounded-3xl h-96 mx-auto"/>
  </section>
</div>
