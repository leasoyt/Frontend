...
import { deleteProduct } from '@/scripts/manager/product-delete';
import { getCategoryById } from '@/scripts/manager/category-byid';
...
import { updateProduct } from '@/scripts/manager/product-update';
  ...
  return (
    <div className="mr-5 mt-1 w-[80%] bg-white border border-gray-300 rounded-lg shadow-lg z-10">
      ...
      <div className="relative overflow-x-auto flex flex-col p-4">
        ...
        <button onClick={handleClick} className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-3 py-1.5 me-2 mb-2 ml-3 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 w-48">
          Nuevo Producto
        </button>
